...
UDEVRULES[99-ftdi]='SUBSYSTEMS==\"usb\", ENV{.LOCAL_ifNum}=\"$attr{bInterfaceNumber}\"\n\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"00\", ENV{ID_MM_TTY_BLACKLIST}=\"1\", SYMLINK+=\"FTDI.0\", MODE=\"0660\"\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"01\", ENV{ID_MM_TTY_BLACKLIST}=\"1\", SYMLINK+=\"FTDI.1\", MODE=\"0660\"\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"02\", ENV{ID_MM_TTY_BLACKLIST}=\"1\", SYMLINK+=\"FTDI.2\", MODE=\"0660\"\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"03\", ENV{ID_MM_TTY_BLACKLIST}=\"1\", SYMLINK+=\"FTDI.3\", MODE=\"0660\"\n'
#UDEVRULES[99-ftdi]='SUBSYSTEMS==\"usb\", ENV{.LOCAL_ifNum}=\"$attr{bInterfaceNumber}\"\n\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"01\", SYMLINK+=\"FTDI.0\", MODE=\"0660\"\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"02\", SYMLINK+=\"FTDI.1\", MODE=\"0660\"\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"03\", SYMLINK+=\"FTDI.2\", MODE=\"0660\"\nSUBSYSTEMS==\"usb\", KERNEL==\"ttyUSB[0-9]*\", ATTRS{idVendor}==\"0403\", ATTRS{idProduct}==\"6011\", ENV{.LOCAL_ifNum}==\"04\", SYMLINK+=\"FTDI.3\", MODE=\"0660\"\n'
